...
<head>
  <meta charset="UTF-8">
  <title>Admin Login - BidZone</title>
  ...
  <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-sm">
    ...
    <form action="AdminLoginServlet" method="post" class="space-y-4">
      <div>
        ...
        <input type="text" name="username" required class="w-full px-3 py-2 bg-white text-black border border-orange-400 rounded focus:outline-none focus:ring-2 focus:ring-orange-500" />
      </div>
      <div>
        <label class="block text-sm font-medium text-black mb-1">Password</label>
        <input type="password" name="password" required class="w-full px-3 py-2 bg-white text-black border border-orange-400 rounded focus:outline-none focus:ring-2 focus:ring-orange-500" />
      </div>
      <button type="submit" class="w-full bg-orange-600 text-white font-semibold py-2 rounded hover:bg-orange-700 transition">
        Login
      </button>
    </form>
