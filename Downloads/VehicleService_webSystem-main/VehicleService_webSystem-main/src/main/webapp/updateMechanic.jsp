...
<head>
<meta charset="UTF-8">
<title>Update Mechanic Details</title>
...
window.onload = function() {
	...
	<main style="margin-top: 50px;">
		<form action="updateMechanicServlet" method ="post">
			<h3> Update Mechanic Detaila</h3>
			
			<table>
				<tr>
					<td> Mechanic ID:</td>
					<td><input type="text" class="form-control" id="mechanicID" name="mechanicID" value=<%= mechanicID%> readonly></td>
					
				</tr>
				
				<tr>
					<td>Mechanic Name</td>
					<td><input type="text" class="form-control" id="mechanicName" name="mechanicName" value=<%= mechanicName%> readonly></td>
				</tr>
				
				<tr>
					<td>Contact Number</td>
					<td><input type="tel" class="form-control" id="mechanicContact" name="mechanicContact" value=<%= mechanicContact%> required></td>
				</tr>
				
				<tr>
					<td>Specialty</td>
					<td><input type="text" class="form-control" id="specialty" name="specialty" value=<%= specialty%> required></td>
				</tr>
				
				<tr>
					<td>Experience</td>
					<td><input type="text" class="form-control" id="experience" name="experience" value=<%= experience%> required></td>
				</tr>
